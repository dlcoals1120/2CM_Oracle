...
DROP TABLE USER_NO_CONSTANINT;
SELECT * FROM USER_NO_CONSTRAINT;
-- 1, KHUSER01, pass01, 일용자, 남, 01011112222, khuser01@gmail.com

INSERT INTO USER_NO_CONSTRAINT
VALUES(1, 'KHUSER01', 'pass01', '일용자', '남', '01011112222', 'khuser01@gmail.com');
ROLLBACK;
COMMIT;
-- 제약조건
INSERT INTO USER_NO_CONTRAINT
...
CREATE TABLE USER_CHECK (
    ...
    USER_PWD VARCHAR2(30) NOT NULL,
    USER_NAME VARCHAR2(30) NOT NULL,
    USER_GENDER VARCHAR2(30) CHECK(USER_GENDER IN('M', 'F')), -- () 안의 입력 값으로만 입력해야 출력 가능
    USER_PHONE VARCHAR2(30),
    USER_EMAIL VARCHAR2(50)
);
...
-- UNIQUE : 중복이 안 되게 함, NULL은 가능
-- PRIMARY KEY : 중복이 안 되고 NULL도 안 됨. 유일한 값
...
VALUES(1, 'khuser01', 'pass01', '일용자', 'M', '01011112222', 'khuser01@naver.com', '24/06/14');
INSERT INTO USER_DEFAULT
VALUES(1, 'khuser01', 'pass01', '일용자', 'M', '01011112222', 'khuser01@naver.com', DEFAULT);
INSERT INTO USER_DEFAULT
VALUES(2, 'khuser02', 'pass02', '이용자', 'M', '01011112222', 'khuser01@naver.com', SYSDATE+7);
SELECT * FROM  USER_DEFAULT;
-- 제약조건
-- 1. NOT NULL : NULL이 들어가지 않게 함
-- 2. UNIQUE : 중복이 되지 않게함
-- 3. PRIMARY KEY : 중복이 안 되고 NULL이 되지 않도록 함
...
CREATE TABLE USER_FOREIGN_KEY(
    ...
    UAER_PWD VARCHAR2(30) NOT NULL,
    USER_NAME VARCHAR(30) NOT NULL,
    USER_GENDER VARCHAR2(10) CHECK(USER_GENDER IN('M', 'F')),
    USER_PHONE VARCHAR2(30),
    USER_EMAIL VARCHAR2(50),
    USER_DATE DATE DEFAULT SYSDATE,
    -- GENDER_CODE NUMBER REFERENCES USER_GRADE(GRADE_CODE) ON DELETE ON DELETE SET NULL -- ON DELETE SET NULL 붙일 경우 155줄 필요 X
    GENDER_CODE NUMBER REFERENCES USER_GRADE(GRADE_CODE) ON DELETE CASCADE -- 모두 지워버리는 키
);
DROP TABLE USER_FOREIGN_KEY;
-- USER_FOREIGN_KEY에 있는 GRADE_CODE는 USER_CODE의 GRADE_CODE가 가지고 있는 10, 20, 30만 넣을 수 있어요
-- 10, 20, 30 외에 40은 안 돼요 50도 안 돼요
...
-- 테이블명 : SHOP_MEMBER
-- 저장 해야할 데이터 : 1, khuser01, pass01, 일용자, M, 01011112222, khuser01@gmail.com
...
CREATE TABLE SHOP_MEMBER (
    ...
    USER_PWD VARCHAR2(30) NOT NULL,
    USER_NAME VARCHAR(30) NOT NULL,
    USER_GENDER VARCHAR2(30) CHECK(USER_GENDER IN ('M', 'F')),
    USER_PHONE VARCHAR2(30),
    USER_EMAIL VARCHAR(50)
);
INSERT INTO SHOP_MEMBER
VALUES('1', 'khuser01', 'pass01', '일용자', 'M', '01011112222', 'khuser01@gmail.com');
INSERT INTO SHOP_MEMBER
VALUES('2', 'khuser02', 'pass02', '이용자', 'M', '01011112222', 'khuser02@gmail.com');
SELECT * FROM SHOP_MEMBER;
DELETE FROM SHOP_MEMBER WHERE USER_ID = 'khuser01';
COMMIT;

-- 테이블명 : SHOP_BUY
-- 저장 해야할 데이터 : 1, khuser01, 농구화, 24/06/14
...
-- 외래키 FOREIGN KEY
-- 자식 테이블에서 부모 테이블이 가지고 있는 컬럼의 필드값으로만 INSERT 하도록 하는 것
-- 참조 무결성을 보장하는 제약조건임.
-- 외래 키 설정방법
-- 컴럼레벨 : REFERENCES 부모 테이블(컬럼명) 삭제 옵션(ON DELETE SET NULL, ON DELETE CASADE)
-- 외래키 삭제옵션
-- 1. 기본 옵션 ON DELET RESTRICTED
-- 2. 연관된 모든 것 삭제 옵션 : ON DELETE CASADE
